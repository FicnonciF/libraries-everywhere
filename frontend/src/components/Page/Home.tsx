          ...
          {carouselItems.map((item, index) => (
            <div key={index} className="relative h-screen w-full">
              ...
              <div className="relative z-10 flex flex-col items-start justify-center h-full text-left pl-20">
                <h2 className="text-2xl font-roboto font-bold text-white mb-6 drop-shadow-lg">
                  {item.head}
                </h2>
                <h1 className="text-5xl font-playfair md:text-6xl font-bold text-white mb-6 drop-shadow-lg">
                  {item.title}
                </h1>
                <p className="text-xl font-roboto md:text-2xl text-white mb-8 max-w-2xl drop-shadow">
                  {item.subtitle}
                </p>
              </div>
            </div>
